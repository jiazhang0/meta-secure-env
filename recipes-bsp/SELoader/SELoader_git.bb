...
python do_sign() {
    sb_sign('${S}/Src/Efi/SELoader.efi', '${B}/SELoader${EFI_ARCH}.efi', d)
    sb_sign('${S}/Bin/Hash2DxeCrypto.efi', '${B}/Hash2DxeCrypto.efi.signed', d)
    sb_sign('${S}/Bin/Pkcs7VerifyDxe.efi', '${B}/Pkcs7VerifyDxe.efi.signed', d)
}
